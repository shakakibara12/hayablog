...
# Create a post
@app.post(
    "/api/create/post", response_model=PostResponse, status_code=status.HTTP_201_CREATED
)
...
# Create user
@app.post(
    "/api/create/user", response_model=UserResponse, status_code=status.HTTP_201_CREATED
)
